                ...
                {filteredProjectLists.map((project) => {
                    return (
                        <div key={project.id} className="relative overflow-hidden shadow-lg bg-[#262626] p-0 rounded-xl">
                            ...
                            <button onClick={() => collaborateClick(project.id, project.repolink)} href={project.repoLink} target="_blank" className='bg-purple-500 text-white bottom-0 p-4 flex w-full justify-center items-center absolute'>Collaborate</button>
                        </div>
                    );
                })}
